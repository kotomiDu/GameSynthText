...
class FontColor(object):
    ...
    def __init__(self, col_file):
        with open(col_file,'rb') as f:
            self.colorsRGB = cp.load(f,encoding='iso-8859-1')
    ...
    def mean_color(self, arr):
        ...
        return np.squeeze(cv.cvtColor(col[None,None,:],cv.CV_HSV2RGB))
...
class Colorize(object):
    ...
    def __init__(self, model_dir='data', font_color = None):#, im_path):
        ...
        self.font_color_user = font_color
    ...
    def color_text(self, text_arr, h, bg_arr):
        ...
        if self.font_color_user is not None:
            fg_col = self.font_color_user
